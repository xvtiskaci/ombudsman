...
class AddRecommendationPage(BaseForm):
    ...
    __date_picker = Button(By.XPATH, "//input[@id='datePicker']", "date picker")
    __pick_date = Button(By.XPATH, "//div[@aria-label='პარასკევი, 15 სექტემბერი 2023']", "15 sect")
    ...
    __add_activity_main = Input(By.XPATH, "//input[@placeholder='აქტივობა']", "aqtivobis damateba")
    __add_activity_button = Button(By.XPATH, "//button[contains(text(),'აქტივობის დამატება')]", "indikatorshi aqtivobis damatebis gilaki")
    __add_activity_child = Input(By.XPATH, "//div[@class='_AppForm__Container_1nxup_48']//div[3]//input[1]", "shvilobili aqtivoba")
    __plus_button = Button(By.XPATH, "//figure[@class='_AppButton__Add_1kh68_24']//*[name()='svg']", "pliusis gilaki")
